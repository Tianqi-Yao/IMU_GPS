#!/usr/bin/env python3
"""
Replay recorded Robot JSONL data as a WebSocket stream.

This lets collaborators run Robot consumers without live hardware.

Example:
    python replay_robot_websocket.py
"""
...
INPUT_PATH = Path(__file__).parent / "data_log" / "robot_raw_v1.jsonl"
HOST = "0.0.0.0"
PORT = 8889
HZ = 20.0
LOOP_FOREVER = True
