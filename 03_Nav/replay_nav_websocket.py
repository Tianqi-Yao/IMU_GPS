#!/usr/bin/env python3
"""
Replay recorded Nav JSONL data as a WebSocket stream.

This lets collaborators run Nav consumers without live upstream IMU/RTK.

Example:
    python replay_nav_websocket.py
"""
...
INPUT_PATH = Path(__file__).parent / "data_log" / "nav_raw_v1.jsonl"
HOST = "0.0.0.0"
PORT = 8786
HZ = 10.0
LOOP_FOREVER = True
