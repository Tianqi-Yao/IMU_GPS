#!/usr/bin/env python3
"""
Replay recorded Camera JSONL status data as a WebSocket stream.

Usage:
    python replay_camera_websocket.py
"""
...
INPUT_PATH = Path(__file__).parent / "data_log" / "camera_raw_v1.jsonl"
HOST = "0.0.0.0"
PORT = 8816
HZ = 1.0
LOOP_FOREVER = True
