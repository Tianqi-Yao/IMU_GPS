"""replay_nav_websocket.py — hardware-free WebSocket source for 03_Nav.

Broadcasts a recorded data_log/*.jsonl file on the same WebSocket port
nav_bridge.py normally uses. By default replays the most recently recorded
file.

Run: python replay_nav_websocket.py
"""
...
def main() -> None:
    if INPUT_PATH is None:
        raise SystemExit(
            ...
            "Run listen_nav_websocket.py against a real bridge first."
        )
